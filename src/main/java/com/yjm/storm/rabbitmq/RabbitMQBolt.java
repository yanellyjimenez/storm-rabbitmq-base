...
public class RabbitMQBolt extends BaseRichBolt {
  ...
  public RabbitMQBolt(final MultiStreamSplitter streamSplitter, final TupleToMessage scheme) {
    this(streamSplitter, scheme, new Declarator.NoOp());
  }

  public RabbitMQBolt(final MultiStreamSplitter streamSplitter, final TupleToMessage scheme, final Declarator declarator) {
	    this.scheme = scheme;
  ...
  public void declareOutputFields(final OutputFieldsDeclarer declarer) {
	      declarer.declare(new Fields( streamSplitter.streamNames() ));
  }
}
